...
public class Constants {
    ...
    public final static String USERNAME = "techie";
    public final static String USER_NOT_AVAIL = "user not available for the userId";
    // public static final String PASSWORDS_DONT_MATCH_ERROR = "Invalid User Name or Password ";
    ...
    public static final int MAX_INVALID_LOGIN_ATTEMPT_COUNT = 5;
